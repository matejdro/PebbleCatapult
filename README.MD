...
**Note: Until Core merges [PebbleKit2 PR](https://github.com/coredevices/mobileapp/pull/26),
this app is only compatible with the [microPebble](https://github.com/matejdro/microPebble).**
