package com.matejdro.catapult.crashreport
...
import com.matejdro.catapult.logging.FileLoggingControllerImpl
                  ...
                  ErrorReport(
                     ...
                     openGithubIssue = {
                        val searchIntent = Intent().apply {
                           ...
                           data = "https://github.com/matejdro/PebbleCatapult/issues/new".toUri()
                        }
