...
class TaskerIntentUi extends Intent {
    ...
    public static Status testStatus(Context c) {
        ...
        else if (!TaskerIntentUi.prefSet(c, PROVIDER_COL_NAME_ENABLED))
            result = Status.NotEnabled;
        else if (!TaskerIntentUi.prefSet(c, PROVIDER_COL_NAME_EXTERNAL_ACCESS))
            result = Status.AccessBlocked;
        else if (!new TaskerIntentUi("").receiverExists(c))
    ...
    public static IntentFilter getCompletionFilter(String taskName) {
        ...
        IntentFilter filter = new IntentFilter(TaskerIntentUi.ACTION_TASK_COMPLETE);
    ...
    public TaskerIntentUi() {
        super(ACTION_TASK);
        setRandomData();
        putMetaExtras(getRandomString());
    }

    public TaskerIntentUi(String taskName) {
        super(ACTION_TASK);
        setRandomData();
        putMetaExtras(taskName);
    }

    public TaskerIntentUi setTaskPriority(int priority) {
    ...
    public TaskerIntentUi addParameter(String value) {
    ...
    public TaskerIntentUi addLocalVariable(String name, String value) {
    ...
    public TaskerIntentUi addAction(int code) {
    ...
    // string arg
    public TaskerIntentUi addArg(String arg) {
    ...
    // int arg
    public TaskerIntentUi addArg(int arg) {
        Bundle b = getActionBundle();
    ...
    // boolean arg
    public TaskerIntentUi addArg(boolean arg) {
        Bundle b = getActionBundle();
    ...
    // Application arg
    public TaskerIntentUi addArg(String pkg, String cls) {
        Bundle b = getActionBundle();
